...
use crate::types::{BusinessConnectionId, Recipient, Seconds, Story, StoryId};

impl_payload! {
    /// Reposts a story previously posted by another chat that the bot manages a business connection for. Returns [`Story`] on success.
    ///
