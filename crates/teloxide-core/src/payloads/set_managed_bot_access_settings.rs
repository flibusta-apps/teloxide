...
impl_payload! {
    ...
    pub SetManagedBotAccessSettings (SetManagedBotAccessSettingsSetters) => True {
        ...
        optional {
            /// A JSON-serialized list of up to 10 identifiers of users who will have access to the bot in addition to its owner. Ignored if _is\_access\_restricted_ is false.
