...
impl_payload! {
    /// Returns gifts owned by a chat. Returns [`OwnedGifts`] on success.
    ///
    ...
    pub GetChatGifts (GetChatGiftsSetters) => OwnedGifts {
        ...
        optional {
            /// Pass _true_ to exclude gifts that aren't saved to the chat's profile page. Always _true_, unless the bot has the can_post_messages administrator right in the channel
            pub exclude_unsaved: bool,
            /// Pass _true_ to exclude gifts that are saved to the chat's profile page. Always _false_, unless the bot has the can_post_messages administrator right in the channel
